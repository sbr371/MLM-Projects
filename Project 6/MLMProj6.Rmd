...
### Write down model
$$
MATH = b_0 + b_1YEAR_{ijk} + \zeta_{k} + \varepsilon_{ijk}
$$
With $\zeta_{k}$ ~ N(0,$\sigma^2_{\zeta}$)  and $\varepsilon_{ijk}$ ~ N(0,$\sigma^2_{\varepsilon}$), all independent of each other.
...
The LRT test says it's significant.
